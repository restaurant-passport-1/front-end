            ...
            <div className="modal-content">
                ...
                <div className="row">
                    <div className="input-field">
                        <p>
                            <label>
                                <input type="checkbox" className="filled-in" name="stamped" checked={stamped} value={stamped}
                              onChange={e => setCheck(!stamped)} /><span>Stamped</span>
                            </label>
